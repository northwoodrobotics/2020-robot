...
public class Drivetrain extends Subsystem {
	...
	private static final double side = 18;
	...
	public void init() {
		...
		swerveDrive = new SwerveDrive(swerveEnclosureFrontleft, swerveEnclosureFrontright, swerveEnclosureBackright, swerveEnclosureBackleft, swerveEnclosureBack, side);
